...
class Ui_configDialog(object):
    def setupUi(self, configDialog):
        ...
        configDialog.resize(573, 444)
        self.varsBox = QtWidgets.QGroupBox(configDialog)
        self.varsBox.setGeometry(QtCore.QRect(20, 200, 531, 181))
        ...
        self.logLocationChooser = QtWidgets.QToolButton(self.gridLayoutWidget_2)
        self.logLocationChooser.setObjectName("logLocationChooser")
        self.varsGridLayout.addWidget(self.logLocationChooser, 3, 4, 1, 1)
        ...
        self.logDirLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.logDirLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.logDirLabel.setObjectName("logDirLabel")
        self.varsGridLayout.addWidget(self.logDirLabel, 3, 0, 1, 1)
        ...
        self.logDirEntry = QtWidgets.QLineEdit(self.gridLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.logDirEntry.sizePolicy().hasHeightForWidth())
        self.logDirEntry.setSizePolicy(sizePolicy)
        self.logDirEntry.setObjectName("logDirEntry")
        self.varsGridLayout.addWidget(self.logDirEntry, 3, 1, 1, 3)
        ...
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(configDialog)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(120, 390, 421, 32))
        ...
        self.okCancelLayout.addItem(spacerItem1)
        self.cancelButton = QtWidgets.QPushButton(self.horizontalLayoutWidget_2)
        self.cancelButton.setStyleSheet("QPushButton {background: white; border 1px solid black}\n"
"QPushButton.pushed {background: #a6a6a6}")
        ...
        self.saveButton.setStyleSheet("QPushButton {background: white; border 1px solid black}\n"
"QPushButton.pushed {background: #a6a6a6}")
        self.saveButton.setObjectName("saveButton")
        self.okCancelLayout.addWidget(self.saveButton)
        self.mediaBox = QtWidgets.QGroupBox(configDialog)
        self.mediaBox.setGeometry(QtCore.QRect(20, 40, 531, 151))
        ...
        self.progNameTitle = QtWidgets.QLabel(configDialog)
        self.progNameTitle.setGeometry(QtCore.QRect(30, 10, 511, 21))
        self.progNameTitle.setAlignment(QtCore.Qt.AlignCenter)
        self.progNameTitle.setObjectName("progNameTitle")
    ...
    def retranslateUi(self, configDialog):
        ...
        self.varsBox.setTitle(_translate("configDialog", "System Variables"))
        self.progNameLabel.setText(_translate("configDialog", "Program Title"))
        self.logLocationChooser.setText(_translate("configDialog", "..."))
        self.testmodeCheck.setText(_translate("configDialog", "Test Mode"))
        self.logDirLabel.setText(_translate("configDialog", "Log Location"))
        self.filebotChooser.setText(_translate("configDialog", "..."))
        self.versionLabel.setText(_translate("configDialog", "Version Number"))
        self.filebotLocLabel.setText(_translate("configDialog", "Filebot Location"))
        self.cancelButton.setText(_translate("configDialog", "Cancel"))
        self.saveButton.setText(_translate("configDialog", "OK"))
        self.mediaBox.setTitle(_translate("configDialog", "Media Directories"))
        self.tvLabel.setText(_translate("configDialog", "TV Shows"))
        self.moviesLabel.setText(_translate("configDialog", "Movies"))
        self.downloadLabel.setText(_translate("configDialog", "Downloads"))
        self.moviesChoose.setText(_translate("configDialog", "..."))
        self.tvChoose.setText(_translate("configDialog", "..."))
        self.downloadChoose.setText(_translate("configDialog", "..."))
        self.progNameTitle.setText(_translate("configDialog", "TextLabel"))
