...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(602, 476)
        self.varsBox = QtWidgets.QGroupBox(Dialog)
        self.varsBox.setGeometry(QtCore.QRect(20, 200, 531, 191))
        ...
        self.logFileLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.logFileLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.logFileLabel.setObjectName("logFileLabel")
        self.varsGridLayout.addWidget(self.logFileLabel, 3, 0, 1, 1)
        ...
        self.dialogTitle = QtWidgets.QLabel(Dialog)
        self.dialogTitle.setGeometry(QtCore.QRect(20, 10, 561, 21))
        font = QtGui.QFont()
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(80, 401, 481, 63))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.logFileLabel.setText(_translate("Dialog", "Log File Location"))
        self.versionLabel.setText(_translate("Dialog", "Version Number"))
        self.logLocationChooser.setText(_translate("Dialog", "..."))
        ...
        self.dialogTitle.setText(_translate("Dialog", "TextLabel"))
